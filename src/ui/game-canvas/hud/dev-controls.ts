...
export function drawDevAutoButton(_rt: GameCanvasRuntime,
  shellCtx: CanvasRenderingContext2D,
  rect: { x: number; y: number; w: number; h: number },
  active: boolean,
  scale: number,
...
export function drawDevSpeedUpButton(_rt: GameCanvasRuntime,
  shellCtx: CanvasRenderingContext2D,
  rect: { x: number; y: number; w: number; h: number },
  enabled: boolean,
  scale: number,
