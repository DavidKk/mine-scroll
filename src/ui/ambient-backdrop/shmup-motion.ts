...
function shmupShipRawPos(nowMs: number, shellW: number, shellH: number): { x: number; y: number } {
  ...
  const nx =
    Math.sin(t * 0.71 + 1.2) * 0.36 +
    Math.sin(t * 1.33 + 2.8) * 0.22 +
    Math.cos(t * 0.39 + 0.5) * 0.16 +
    Math.sin(t * 1.97 + 4.1) * 0.1;
  const ny =
    Math.sin(t * 0.88 + 3.1) * 0.4 +
    Math.cos(t * 1.49 + 1.7) * 0.26 +
    Math.sin(t * 0.63 + 2.2) * 0.14;
