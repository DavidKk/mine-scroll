...
function clearCellClasses(cell: HTMLElement): void {
  cell.classList.remove(
    'boot-screen__cell--scan',
    'boot-screen__cell--revealed',
    'boot-screen__cell--mine',
    'boot-screen__cell--zero',
    'boot-screen__cell--pressed',
  );
  for (let n = 1; n <= 8; n += 1) {
...
export function attachBootMiniBoard(
  cells: HTMLElement[],
  options: { onFirstInteract?: () => void } = {},
): () => void {
