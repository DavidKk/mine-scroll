...
import {
  ...
  HEART_REFILL_V3_MS,
  V3_CANDIDATE_HEART_EMPTY_SRC,
  V3_CANDIDATE_HEART_FULL_SRC,
} from './types.ts';
...
export function drawHeartRefillV3Scene(
  ctx: CanvasRenderingContext2D,
  w: number,
  h: number,
  tMs: number,
...
export function drawHeartStaticV3Scene(
  ctx: CanvasRenderingContext2D,
  w: number,
  h: number,
  full: boolean,
...
export function drawPanelV3Scene(
  ctx: CanvasRenderingContext2D,
  w: number,
  h: number,
  kind: PanelConceptKind,
