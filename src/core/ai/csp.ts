...
export function enumerateMineProbabilities(
  vars: string[],
...
export function componentProbabilities(
  board: SolverBoard,
  deduced: Deduction,
  vars?: string[],
): Map<string, number> | null {
...
export function mineProbability(
  board: SolverBoard,
  deduced: Deduction,
  row: number,
  col: number,
...
export function pickLowestProb(
  probs: Map<string, number>,
  board: SolverBoard,
  preferRow?: number,
): { row: number; col: number; prob: number } | null {
