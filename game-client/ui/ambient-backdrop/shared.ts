...
export function strokeRoundedLoop(ctx: CanvasRenderingContext2D, points: Point2[], lineW: number, cornerR: number, stroke: string): void {
...
export function drawDeepVoid(ctx: CanvasRenderingContext2D, shellW: number, shellH: number, colors: CosmicPalette): void {
...
export function drawSkyWash(ctx: CanvasRenderingContext2D, shellW: number, shellH: number, colors: CosmicPalette, glow: number): void {
  ctx.save()
...
export function drawEdgeFade(ctx: CanvasRenderingContext2D, shellW: number, shellH: number, intensity: number): void {
