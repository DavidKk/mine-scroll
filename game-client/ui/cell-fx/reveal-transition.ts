...
export function drawCellRevealTransitionOverlay(ctx: CanvasRenderingContext2D, x: number, y: number, g: GridMetrics, progress: number): void {
  ...
  roundedRectPath(ctx, x - g.cellSize * 0.08 * t, y - g.cellSize * 0.08 * t, g.cellSize * (1 + 0.16 * t), g.cellSize * (1 + 0.16 * t), g.cellRadius + 4)
  ctx.stroke()
