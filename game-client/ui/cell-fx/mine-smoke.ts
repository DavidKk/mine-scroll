...
function drawSmokePuff(ctx: CanvasRenderingContext2D, px: number, py: number, radius: number, alpha: number): void {
...
export function drawMineBurstSmoke(ctx: CanvasRenderingContext2D, cx: number, cy: number, cellSize: number, progress: number, intensity = 1): void {
...
export function drawMineSettledSmoke(ctx: CanvasRenderingContext2D, cx: number, cy: number, cellSize: number, nowMs: number, intensity = 1): void {
  ctx.save()
  ctx.globalCompositeOperation = 'lighter'
...
export function drawMineScorchMark(ctx: CanvasRenderingContext2D, cx: number, cy: number, cellSize: number): void {
  ctx.save()
