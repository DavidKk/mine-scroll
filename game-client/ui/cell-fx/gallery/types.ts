...
export type BoardV3TileKey = 'cell-hidden' | 'cell-revealed' | 'cell-hover' | 'cell-pressed' | 'cell-safe' | `num-${1 | 2 | 3 | 4 | 5 | 6 | 7 | 8}`
...
export const DIGIT_COLORS = ['#60a5fa', '#34d399', '#f87171', '#fbbf24', '#c084fc', '#22d3ee', '#ec4899', '#fb923c']
