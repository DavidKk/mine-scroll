...
import type { ComboBurstFxDrawOptions, ComboBurstFxProgress, ComboBurstV3DrawOptions, ComboBurstV3Layout } from './types.ts'

export function drawComboBurstFx(ctx: CanvasRenderingContext2D, opts: ComboBurstFxDrawOptions): void {
  const { cx, cy, combo, progress, stageScale, burstW, burstH, fontFamilyMono } = opts
