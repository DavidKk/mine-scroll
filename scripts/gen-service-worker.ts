...
import { BRAND_LOGO_PATH, BRAND_MARK_PATH, BRAND_OG_IMAGE_PATH } from '../lib/brand.ts'
...
const CACHE_NAME = 'chill-minesweeper-v${cacheVersion}';
...
console.log(`service-worker: ${precacheList.length} precache urls → public/sw.js`)
