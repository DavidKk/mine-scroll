...
function isRowAiConfirmed(board: SolverBoard, safe: Set<string>, mines: Set<string>, row: number): boolean {
...
export function isBottomRowsAiConfirmed(board: SolverBoard, safe: Set<string>, mines: Set<string>, batchRows: number): boolean {
 ...
 */
export function pickScrollMove(session: ModeSession, tactical: AiMove | null, board: SolverBoard, safe: Set<string>, mines: Set<string>, batchRows: number): AiMove | null {
